...
const destinationUrl = 'https://expotuna.clopezpro.com/'
const countdown = ref(4)
let timer: ReturnType<typeof setInterval> | null = null

useSeoMeta({
  title: 'Página Reubicada | SRI-MATCH',
  description: 'Esta herramienta fue movida a su nuevo enlace oficial https://expotuna.clopezpro.com/',
        ...
        >
          ...
          <div class="space-y-2">
            ...
            <h1 class="text-xl sm:text-2xl font-bold text-highlighted">
              El sistema SRI-MATCH fue movido a un nuevo enlace
            </h1>
            <p class="text-sm text-muted leading-relaxed max-w-md mx-auto">
              Esta aplicación ahora se encuentra implementada en su nueva dirección oficial:
              <span class="font-semibold text-highlighted">expotuna.clopezpro.com</span>.
            </p>
          </div>
